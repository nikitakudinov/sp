...
export '/team/l_i_s_t_team/l_i_s_t_team_widget.dart' show LISTTeamWidget;
export '/team/e_d_i_t_e_team/e_d_i_t_e_team_widget.dart' show EDITETeamWidget;
...
export '/messages/chat/chat_widget.dart' show ChatWidget;
